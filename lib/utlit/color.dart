...
class colorconst{
  ...
  static const BLACK=Color(0xff000000);
    ...
    static const GREYSH2=Color(0xffC4C4C4);
    static const GREYSH4=Color(0xffA8A8A9);
    static const GREYSH5=Color(0xff676767);
    static const WHITE=Color(0xffFFFFFF);
    static const GRAY6=Color(0xff575757);
    static const CIRCLEINSIDE=Color(0xffFCF3F6);
